...
@groovy.transform.BaseScript ScriptTool scriptTool
    ...
    parms.allHolds = input("All Holds",'N',ck.isInList.rcurry(['Y','y','N','n'])).toUpperCase()
    ...
    String title = 'List ' + (parms.allHolds == 'Y') ? 'Active Holds for ' : ''
    ...
    .addColHead(  6, 'L',"%-6s",     ["Level"])
    .addColHead(  6, 'L',"%-6s",     ["Class"])
    .addColHead(  7, 'L',"%-7s",     ["Status"])
    .addColHead(  6, 'L',"%-6s",     ["FAFSA"])
    .addColHead( 31, 'L',"%-30s",     ["College"])
    .addColHead( 11, 'R',"%,10.2f ", ["Balance "])
    .addColHead(  5, 'L',"%-5s",     ["Hold"])
